...
class helloworld_FMRX_QT(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Helloworld Fmrx Qt")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Helloworld Fmrx Qt")
        ...
        self.settings = Qt.QSettings("GNU Radio", "helloworld_FMRX_QT")
        ...
        self.channel_freq2 = channel_freq2 = 88.336e6
        ...
        # Blocks
        ##################################################
        self._channel_freq_range = Range(1.8e9, 5.5e9, 0.1e9, 2.4e9, 200)
        ...
        self._audio_gain_range = Range(0, 1.5, 0.1, 1, 100)
...
def main(top_block_cls=helloworld_FMRX_QT, options=None):
